...
* # individual/family
*/
app.directive('family', ['business', '$timeout', function (Business, $timeout) {
  return {
    ...
    link: function postLink(scope, element, attrs) {
      Business.individual.getFamily(scope.personId).then(function(result){
        console.log('family', result);
        scope.family = result? result: [];
      }, function(){
        scope.family = [];
      });
      Business.individual.getIndData(scope.personId).then(function(result){
        scope.person = result? result : {};
      })
      ...
      // var circles = svg.selectAll("circle").on("mouseover", myMouseoverFunction).on("mouseout", myMouseoutFunction);
      // var gs = svg.selectAll("g").on("mouseover", function() {
