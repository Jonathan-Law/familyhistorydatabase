...
$_MYSESSION_CONF['DB_SERVER']       =   DB_SERVER;          //MySql server
$_MYSESSION_CONF['DB_USERNAME']     =   DB_SESSION;            //MySql user
...
$_MYSESSION_CONF['OVERWRITE_PHP_FUNCTION']   =   0;         //the class overwrite php session function
...
#Section 2.3: Cripto
$_MYSESSION_CONF['CRIPT']           =   0;                  //Use AES cryptography to store session vars - 1 to encrypt data - 0 to use plain data
$_MYSESSION_CONF['CRIPT_KEY']       =   "1195Jonathan!CryptKey";  //Encrypt Key: The strongest key that your mind can think. You do not need to remember it!!!

#Section 2.4: Hijacking Prevention
$_MYSESSION_CONF['ENABLE_ANTI_HIJACKING'] = 0;              //Use UserAgent check to prevent Hijacking
