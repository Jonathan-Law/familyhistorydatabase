               ...
               <div id="header">
                  <div id="logo_wrap">
                     ...
                     <div id="login_wrap" class="clearfix">
                        <h1>Here are the benefits of a verified account:</h1>
                        <ol>
                           <li>The ability to submit photos and stories to be included in the website.</li>
                           <li>The ability to choose ansestors to follow and get notifications when their pages change.</li>
                           <li>Blogging privileges.</li>
                        </ol>
